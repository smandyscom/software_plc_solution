...
namespace metaData
{
	...
	namespace	device{
		...
		int writeIn					(DEV_METADATA		*dmds,const int itemCode,const char*	data);
		const char*		readOut		(const DEV_METADATA *dmds,int&		itemCode,size_t&		dataSize);	//added by Hsien , 2013.04.19
