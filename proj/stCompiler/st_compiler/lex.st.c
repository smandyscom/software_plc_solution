#define yy_create_buffer st_create_buffer
#define yy_delete_buffer st_delete_buffer
#define yy_scan_buffer st_scan_buffer
#define yy_scan_string st_scan_string
#define yy_scan_bytes st_scan_bytes
#define yy_flex_debug st_flex_debug
#define yy_init_buffer st_init_buffer
#define yy_flush_buffer st_flush_buffer
#define yy_load_buffer_state st_load_buffer_state
#define yy_switch_to_buffer st_switch_to_buffer
#define yyin stin
#define yyleng stleng
#define yylex stlex
#define yyout stout
#define yyrestart strestart
#define yytext sttext
#define yylineno stlineno
...
static yyconst short int yy_acclist[106] =
    {   0,
       41,   39,   40,   38,   39,   40,   38,   40,   27,   39,
       40,   33,   39,   40,   26,   39,   40,   24,   39,   40,
       25,   39,   40,   31,   39,   40,   30,   39,   40,   21,
       39,   40,   29,   39,   40,    2,   39,   40,   32,   39,
       40,    3,   39,   40,   22,   39,   40,   18,   39,   40,
       34,   39,   40,   23,   39,   40,   35,   39,   40,    1,
       39,   40,   36,   39,   40,   39,   40,   39,   40,   39,
       40,   39,   40,   19,   39,   40,   37,   39,   40,   20,
       39,   40,   28,   39,   40,   17,   20,   12,    4,    3,
       19,   11,   14,   16,   15,   10,    1,    1,    6,   13,
...
static yyconst short int yy_accept[64] =
    {   0,
       ...
       51,   54,   57,   60,   63,   66,   68,   70,   72,   74,
       77,   80,   83,   86,   87,   88,   89,   90,   91,   92,
       93,   94,   95,   96,   97,   98,   99,   99,   99,   99,
      100,  100,  101,  102,  102,  103,  103,  103,  104,  105,
      105,  106,  106
    } ;
...
static yyconst int yy_ec[256] =
    {   0,
       ...
       21,   21,   21,   21,   21,   21,   21,   21,   21,   21,
        1,    1,    1,   22,   23,    1,    1,    1,    1,   24,

       25,   26,   27,   28,   29,    1,    1,   30,    1,   31,
...
static yyconst short int yy_base[63] =
    {   0,
        0,    0,   72,   73,   73,   73,   52,   50,   63,   73,
       73,   73,   73,   73,   73,   73,   59,   52,   73,   73,
       35,   47,   22,   22,   73,   16,   33,   38,   35,   73,
       25,   73,   73,   73,   73,   73,   73,   46,   73,   73,
       73,   73,   73,   73,   27,   39,   26,   34,   23,   73,
       27,   73,   34,   27,   73,   19,   19,   73,   73,   19,
       73,   73
    } ;
...
static yyconst short int yy_nxt[113] =
    {   0,
       ...
       24,   25,    4,    4,   26,    4,   27,    4,   28,    4,
        4,    4,    4,    4,   29,   30,   31,   32,   33,   39,
       43,   44,   45,   61,   46,   47,   48,   45,   60,   46,
       59,   58,   40,   41,   53,   57,   56,   55,   54,   53,
       38,   52,   51,   50,   49,   42,   38,   37,   36,   35,
...
static yyconst short int yy_chk[113] =
    {   0,
       ...
       23,   23,   24,   60,   24,   26,   26,   45,   57,   45,
       56,   54,   21,   21,   53,   51,   49,   48,   47,   46,
       38,   31,   29,   28,   27,   22,   18,   17,    9,    8,
        7,    3,   62,   62,   62,   62,   62,   62,   62,   62,
       62,   62,   62,   62,   62,   62,   62,   62,   62,   62,
       62,   62,   62,   62,   62,   62,   62,   62,   62,   62,
...
case 1:
YY_RULE_SETUP
{getString();return(FRAMENAME);}	/*	upper-case	only			*/
	YY_BREAK
case 2:
YY_RULE_SETUP
{getString();return('.');}
...
case 3:
YY_RULE_SETUP
{getInteger();	return(INTEGER);}	/* {D}+"."{D}+		{return(FLOAT);}	not surpport so far*/ 
	YY_BREAK
case 4:
YY_RULE_SETUP
{comment();}				
...
case 8:
YY_RULE_SETUP
{getString();return(END);/* added by Hsien , 2013.01.31 , to solve serious look-ahead problem of LY*/}
	YY_BREAK
case 9:
YY_RULE_SETUP
{getString();return(WHILE); }
	YY_BREAK
case 10:
YY_RULE_SETUP
